...
# ===================================================================
# Fixtures — standalone temp DB with schema, pool pointed at it.
# ===================================================================
...
def _test_db(tmp_path):
    """Create a temp database with the real schema and route the pool to it."""
    db_file = str(tmp_path / "test_rollup.db")
