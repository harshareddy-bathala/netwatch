...
# ===================================================================
# Fixtures  – bypass init_db (its module-level DATABASE_PATH import
# is stale) and create the schema directly from schema.sql.
# ===================================================================
...
def _test_db(tmp_path):
    """
    Create a temp database with the real schema, point the global
    connection pool at it, and tear down afterwards.
    """
    ...
    # Point the connection pool at the temp database
    from database.connection import init_pool, shutdown_pool
    init_pool(db_file, pool_size=2)
