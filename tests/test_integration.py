...
class TestDataFlow:
    ...
    def test_device_data_appears_in_api(self, client, db_connection):
        ...
        db_connection.execute(
            ...
            "(mac_address, ip_address, first_seen, last_seen, total_bytes, packet_count) "
            "VALUES (?, ?, ?, ?, ?, ?)",
...
class TestModeChanges:
    ...
    def test_interface_manager_detects_mode(self):
        ...
        from packet_capture.modes.base_mode import BaseMode
    ...
    def test_mode_change_callback(self):
        ...
        # Can't trigger real mode change in tests, but callback should register
